        ...
        if (sub === 'item') {
            const row = new ActionRowBuilder().addComponents(
                new SelectMenuBuilder()
                    ...
                    .addOptions([
                        { label: 'item1', value: 'item1', description: "Treo Primium (Tier 1)" },
                        { label: 'item2', value: 'item2', description: "Treo Primium (Tier 2)" },
                        { label: 'item3', value: 'item3', description: "Treo Primium (Tier 3)" },
                    ])
            )
